...
elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    ...
    if(ANDROID)
        set(RBINI_OS_ANDROID 1)
    else()
        set(RBINI_OS_LINUX 1)
    endif()
elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Darwin")
    set(RBINI_OS_MACOS 1)
...
if(MSVC)
    set(RBINI_COMPILER_MSVC 1)

    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        set(RBINI_COMPILER_CLANG_CL 1)
    endif()
elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    set(RBINI_COMPILER_CLANG 1)
elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
    set(RBINI_COMPILER_GCC 1)

    execute_process(COMMAND "${CMAKE_CXX_COMPILER}" "--version" OUTPUT_VARIABLE GCC_COMPILER_VERSION)
    string(REGEX MATCHALL ".*(tdm[64]*-[1-9]).*" $RBINI_COMPILER_GCC_TDM "${GCC_COMPILER_VERSION}")
else()
